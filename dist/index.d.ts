...
declare const heroContentSchema: z.ZodObject<{
    ...
    videoMediaId: z.ZodEffects<z.ZodOptional<z.ZodString>, string | undefined, unknown>;
}, "strip", z.ZodTypeAny, {
    title: string;
...
declare const youtubeGalleryContentSchema: z.ZodObject<{
...
declare const sectionContentByType: {
    readonly hero: zod.ZodObject<{
        ...
        videoMediaId: zod.ZodEffects<zod.ZodOptional<zod.ZodString>, string | undefined, unknown>;
    }, "strip", zod.ZodTypeAny, {
        title: string;
        subtitle?: string | undefined;
        cta?: {
    ...
    readonly youtubeGallery: zod.ZodObject<{
        playlistId: zod.ZodString;
        pageSize: zod.ZodDefault<zod.ZodNumber>;
        columns: zod.ZodDefault<zod.ZodNumber>;
...
declare const propertyWatermarkSchema: z.ZodObject<{
...
declare const settingsScalarsSchema: z.ZodEffects<z.ZodObject<{
    ...
    propertyWatermark: z.ZodDefault<z.ZodObject<{
        enabled: z.ZodDefault<z.ZodBoolean>;
        mediaId: z.ZodOptional<z.ZodString>;
    }, "strip", z.ZodTypeAny, {
        enabled: boolean;
...
declare function collectPropertyWatermarkMediaIds(scalars: Pick<SettingsScalars, 'propertyWatermark'> | undefined): string[];
/** Collect all branding scalar media UUIDs (logos + property watermark). */
declare function collectBrandingMediaIds(scalars: SettingsScalars | undefined): string[];
