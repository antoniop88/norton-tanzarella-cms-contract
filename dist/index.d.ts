...
declare const PERFORMANCE_SELL_HERO_TITLES: Set<string>;
 ...
 */
declare function migrateSellWithUsPerformanceCopy(sections: CmsSection[], defaults: CmsPageDocument): CmsSection[];
/**
...
declare const sectionContentByType: {
    ...
    readonly aboutTeaser: zod.ZodObject<{
        title: zod.ZodString;
        body: zod.ZodString;
        button: zod.ZodObject<{
            label: zod.ZodString;
